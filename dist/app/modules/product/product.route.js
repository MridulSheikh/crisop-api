...
router
    .route('/')
    .post((0, auth_1.default)(user_interface_1.UserRole.admin, user_interface_1.UserRole.manager, user_interface_1.UserRole.super), sendImageToCloudinary_1.upload.array('images', 5), (0, validateRequest_1.default)(product_validation_1.createProductSchema), product_controller_1.createProductController)
...
router
    ...
    .patch((0, auth_1.default)(user_interface_1.UserRole.admin, user_interface_1.UserRole.manager, user_interface_1.UserRole.super), sendImageToCloudinary_1.upload.array('newImages', 5), (0, validateRequest_1.default)(product_validation_1.updateProductSchema), product_controller_1.updateProductController)
